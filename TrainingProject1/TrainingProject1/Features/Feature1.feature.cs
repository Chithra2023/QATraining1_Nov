...
#line hidden
        ...
        [NUnit.Framework.TestCaseAttribute("Updated Desc 01", null)]
        [NUnit.Framework.TestCaseAttribute("Desc 01", null)]
        [NUnit.Framework.TestCaseAttribute("CN_Desc 03", null)]
        public void EditExistingMaterialOrTimeRecordWithValidDetails(string description, string[] exampleTags)
        {
...
#line hidden
#line 17
 testRunner.And(string.Format("I update \'{0}\' of an existing Time & Material record", description), ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
#line 18
